...
This project utilizes 20,000+ interactive particles to render volume-based cursed techniques:
...
1.  **Clone the repo**
    ```bash
    git clone [https://github.com/your-username/SAT0RU.git](https://github.com/reinesana/SAT0RU.git)
    cd SAT0RU
    ```
